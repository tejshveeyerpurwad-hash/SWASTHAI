        ...
        >
          ...
          <div className="mb-10">
            ...
            <p className="text-slate-400 font-medium text-sm max-w-sm leading-relaxed">
              Join thousands of people in rural India who use SwasthAI to stay healthy and get help fast.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {[
                { name: 'name',     label: 'Full Name',  icon: User,   placeholder: 'e.g. Priya Sharma',    type: 'text', required: true  },
                { name: 'username', label: 'Username',   icon: User,   placeholder: 'e.g. priya_sharma',    type: 'text', required: true  },
              ].map(field => (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="space-y-1.5">
                <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Email <span className="normal-case font-medium text-slate-300">(optional)</span></label>
                <div className="relative group">
                  <div className="absolute inset-y-0 left-4 flex items-center pointer-events-none text-slate-300 group-focus-within:text-emerald-500 transition-colors">
